...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo get_app_info('path');?>/css/all.css?27" />
		...
		<div class="navbar navbar-fixed-top">
	      ...
	      <div class="navbar-inner">
	        <div class="container-fluid">
	          ...
	          <?php
		 	$client_email = get_app_info('email');
			$client_email="shazia@ading.us";
		   ?>
		          <a class="brand" href="<?php echo get_app_info('path');?>/"><img src="https://www.gravatar.com/avatar/<?php echo md5(strtolower(trim('shazia@ading.us')));?>?s=36&d=<?php echo get_app_info('path');?>/img/sendy-avatar.png" title="" class="main-gravatar" onerror="this.src='<?php echo get_app_info('path');?>/img/sendy-avatar.png'"/><?php echo get_app_info('company');?></a>
	          ...
	          <?php else:?>
		          ...
		          <?php 
			          ...
			          if($logo_filename=='') $logo_image = 'https://www.gravatar.com/avatar/'.md5(strtolower(trim('shazia@ading.us'))).'?s=36&d='.get_app_info('path').'/img/sendy-avatar.png';
	          ...
	          <div class="btn-group pull-right">
	            ...
	            <ul class="dropdown-menu">
	              <li><a href="<?php echo get_app_info('path');?>/settings<?php if(get_app_info('is_sub_user')) echo '?i='.get_app_info('app');?>"><i class="icon icon-cog"></i> <?php echo _('Settings');?></a></li>
								...
								<li><a href="<?php echo get_app_info('path');?>/manage-subscription<?php if(get_app_info('is_sub_user')) echo '?i='.get_app_info('app');?>"><i class="icon icon-cog"></i> <?php echo _('Manage Subscription');?></a></li>
								<?php else: ?>
								<li><a href="<?php echo get_app_info('path');?>/create-plan<?php if(get_app_info('is_sub_user')) echo '?i='.get_app_info('app');?>"><i class="icon icon-cog"></i> <?php echo _('Create Plan');?></a></li>
								<?php endif;?>
	              <li class="divider"></li>
