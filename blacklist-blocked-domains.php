    ...
    <div class="span10">
	    ...
	    <div class="row-fluid">
		    <div class="span12">
				...
				<div class="well" id="import-blocked-domain-list-csv" <?php if(isset($_GET['e'])) echo 'style="display:block;"';?>>
				    ...
				    <form action="<?php echo get_app_info('path')?>/includes/subscribers/import-blocked-domain-list.php" method="POST" accept-charset="utf-8" class="form-vertical" enctype="multipart/form-data" id="import-update-form">
				        ...
				        <a href="javascript:void(0)" id="close-import-btn"><span class="icon icon-remove-sign"></span> <?php echo _('Cancel');?></a>
				    </form>
				</div>
